...
const integrations = [
  { name: "Google Business", category: "Local SEO" },
  ...
  { name: "Angi", category: "Lead Gen" },
  { name: "HomeAdvisor", category: "Lead Gen" },
  { name: "Thumbtack", category: "Lead Gen" },
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12">
        ...
        >
          ...
          <p className="text-xl text-muted-foreground">
            Already using scheduling software or review platforms? Your new site works with them.
          </p>
        </div>
